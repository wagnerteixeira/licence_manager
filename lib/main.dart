...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> setup() async  {
      ...
      final Query query = firestore.collection('releases');
      final QuerySnapshot querySnapshot = await query.getDocuments();
      var doc = querySnapshot.documents;
      var release = doc.first.data["release"] == true;
  
      if(release){
        log('Relese', name: 'info.log', error: {"teste": 1});
      }
      else
        log('Not release', name: 'info.log', error: {"teste": 2});
    }
